...
<head>
	...
	body {
	  padding-top: 40px;
	  padding-bottom: 40px;
	  background-image: url("https://th.bing.com/th/id/R.aff1fcacfdee0bfe7c7c169293b53f38?rik=2QpvjZzFy9GiCw&riu=http%3a%2f%2ffarm5.staticflickr.com%2f4140%2f4754325268_3e98c261be_o.jpg&ehk=nBkWh%2f50SDC7MnJklTrToINZCogaweBzWxQePtZjwPw%3d&risl=&pid=ImgRaw&r=0");
  ...
  <body>
	...
	?>
      <form class="form-signin" method="post" action="" role="form">
		...
		?>
        <div class="container">
  		<h2 class="form-signin-heading text-center text-uppercase text-warning"><b>Tampilan Login</b></h2>
        <input type="text" name="username" class="form-control" placeholder="Username" required autofocus>
        <input type="password" name="password" class="form-control" placeholder="Password" required>
        <button class="btn btn-lg btn-warning btn-block" type="submit" name="login"><b>Login</b></button>
		</div>
      </form>
	<?php
	}
